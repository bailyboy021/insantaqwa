...
echo form_open(base_url('admin/video/edit/'.$video->id));
?>
<div class="col-md-12">
...
<textarea name="keterangan" class="form-control" placeholder="Keterangan" id="keterangan"><?php echo $video->keterangan;?></textarea>
</div>
...
<input type="text" name="video" class="form-control" placeholder="Kode video Youtube" value="<?php echo $video->url;?>"/>
</div>
